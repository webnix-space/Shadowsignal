...
# ============================================================
#  BAND ROOM (Native Implementation)
# ============================================================
...
class InvestigatorAgent:
    ...
    def _gather_intel(self, target, focus="pricing"):
        ...
        mock_db = {
            ...
            "Nvidia": [
                "NVIDIA GPU Display Driver Vulnerability May 2026: Out-of-bounds write vulnerability allows remote code execution on enterprise AI infrastructure. CVE-2026-XXXX.",
...
class AnalystAgent:
    ...
    def run(self, room, target):
        ...
        room.broadcast(self.name, "ANALYSIS_COMPLETE", 
            f"Impact: {analysis.get('impact_score', 'N/A')}/100, Trend: {analysis.get('trend_direction', 'unknown')}")
        return analysis
...
# Vercel auto-detects Flask 'app' object at module level.
# Do NOT define a custom handler() - it breaks auto-detection.
# The 'app' variable is already defined at the top of this file.
