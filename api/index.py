...
FIXED: Mobile UI responsiveness, smooth scrolling, and tab cutoffs
"""
import os
import json
import logging
...
/* Mobile fix: use 100dvh to prevent bottom cutoff on phones */
body {font-family:var(--font-sans);background:var(--bg-primary);color:var(--text-primary);overflow:hidden;height:100dvh;width:100vw}
...
/* FIXED TAB CUTOFF: Added flex-wrap and horizontal scrolling support */
.panel-tabs {display:flex;background:var(--bg-secondary);border-bottom:1px solid var(--border-color);flex-shrink:0;overflow-x:auto;white-space:nowrap;-webkit-overflow-scrolling:touch;scrollbar-width:none;}
...
/* BOTTOM PADDING FIX: Added padding-bottom to all scrollable areas so content clears the footer */
...
@media(max-width:1024px){
    ...
    .main-interface {height:auto; min-height:100dvh; overflow:visible;}
