...
# --- 3. THE LIVE TERMINAL UI (Forced to load by Flask) ---
DASHBOARD_HTML = """
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="min-h-screen flex flex-col h-screen overflow-hidden">
    ...
    <script>
        ...
        // The function that powers the typing effect in the terminal!
        ...
        async function executeOrchestration() {
            ...
            try {
                // STEP 1: SCRAPE (Backend Endpoint 1)
                ...
                // Pre-render AI cards to show loading state
                ...
                // STEP 2: AI ORCHESTRATION (Backend Endpoint 2)
...
@app.route('/')
def main_dashboard():
    # 🔥 This forces Flask to serve the Live Terminal UI embedded above!
    return render_template_string(DASHBOARD_HTML)

@app.route('/api/scrape', methods=['GET'])
def api_scrape():
    """STEP 1: Prove to the UI we are grabbing live data"""
...
def api_analyze():
    """STEP 2: Run the AI Agents on the scraped data"""
